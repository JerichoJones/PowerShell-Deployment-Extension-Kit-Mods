...
.NOTES
          ...
          Version - 0.1.8 - Set a new TSEnv variable ($TSEnv:InstallFromPath) for the WIM Path to align with MDT
                            I use this to ID which WIM was used to build/deploy
...
# Set a TSEnv variable for the WIM Path to align with MDT
# Used in a later script to write imaging data to the registry
$TSEnv:InstallFromPath = $image
$index = $os.ImageIndex
